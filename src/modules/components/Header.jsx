   ...
   useEffect(() => {
    ...
    return <div className='header-container'>
              <div className='image-container animate__animated'>
                 <img className='image-header' src="/IMG_2318.webp" alt={'header image'}/>
              </div>
              <div className='header-info'>
                 <div className='name-letter'>
                   <h1 className='letter-a animate__animated'>D</h1>
                   <h1 className='letter-t animate__animated'>H</h1>
                 </div>
                 <div className='heder-text-box animate__animated'>
                    <h2 className='heder-text'>
                       Davit & Hasmik <br/> The adventure of lifetime begins
                   </h2>
