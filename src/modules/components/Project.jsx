        ...
        <section className='project-section'>
            ...
            <div className="project-first-image-container">
                    <div className='project-image-1 animate__animated'>
                        <img className='image' src="/IMG_2319.webp" alt={'content image'}/>
                    </div>
                    <div className='project-image-2 animate__animated'>
                         <img className='image' src="/IMG_2317.webp" alt={'content image 1'}/>
                    </div>
                    <div className='project-image-3 animate__animated'>
                         <img className='image' src="/IMG_2320.jpeg" alt={'content image 1'}/>
                    </div>
             </div>
             <PartySection/>
        </section>
